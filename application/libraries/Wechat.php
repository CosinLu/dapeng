...
class Wechat
{
    ...
    */
    ...
    {
        $_str = '<![CDATA['.preg_replace("/[\\x00-\\x08\\x0b-\\x0c\\x0e-\\x1f]/",'',$str).']]>';
        return $_str;
    }
    ...
    */
    ...
    protected function setCache($cachename,$value,$expired)
    {
        ...
        $kv = new KvController();
        return $kv->setCache($cachename,$value,$expired);
    }
    ...
    {
        $this->access_token = $this->checkAuth();
